/**
 * Timezone Utilities
 * For converting dates to restaurant timezone in reports and analytics
 *
 ...
 * Used for accurate date range queries in reports
 *
 * @param date - Date to convert
 * @param timezone - Target timezone (IANA timezone string)
 * @returns Date object in restaurant timezone
 */
