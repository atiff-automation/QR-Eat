  ...
  const generateReport = async () => {
    try {
      ...
      if (format === 'csv' || format === 'pdf') {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        const data = await ApiClient.post<{ report: any }>(
          `/api/staff/analytics/${restaurantId}/report`,
          {
            reportType: 'financial',
            dateRange: {
    ...
    <div className="p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">
          Comprehensive financial analysis including revenue, payments, and
          refunds
        </p>
      </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Generated on{' '}
                  {new Date(report.generatedAt).toLocaleDateString()} by{' '}
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-2xl font-semibold text-green-900">
                        ${report.data.revenue.gross.toFixed(2)}
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-2xl font-semibold text-blue-900">
                        ${report.data.revenue.net.toFixed(2)}
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-2xl font-semibold text-purple-900">
                        ${report.data.revenue.tax.toFixed(2)}
                      </p>
                    </div>
                  </div>
                </div>
          ...
          {report.data?.paymentMethods && (
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              ...
              <div className="space-y-3">
                {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
                {report.data.paymentMethods.map(
                  (method: any, index: number) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-xs text-gray-500">
                          {(
                            (method.amount / report.data.revenue.gross) *
                            100
                          ).toFixed(1)}
                          % of total
                        </p>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-2xl font-semibold text-red-900">
                        ${report.data.refunds.totalAmount.toFixed(2)}
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-2xl font-semibold text-orange-900">
                        {report.data.refunds.totalCount}
                      </p>
                    </div>
                  </div>
                </div>
