            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                <h3 className="font-semibold text-yellow-800 mb-2">
                  ⚠️ Important: Owner Login Credentials
                </h3>
                <p className="text-yellow-700 mb-2">
                  The restaurant owner will need these credentials to log in:
                </p>
                <div className="bg-white p-3 rounded border border-yellow-300">
                  <p>
                    <strong>Email:</strong> {createdRestaurant.owner.email}
                  </p>
                  <p>
                    <strong>Temporary Password:</strong>{' '}
                    <code className="bg-gray-100 px-2 py-1 rounded">
                      {createdRestaurant.owner.tempPassword}
                    </code>
                  </p>
                </div>
                <p className="text-yellow-700 mt-2 text-sm">
                  📧 A welcome email has been sent to the owner with these
                  credentials and setup instructions. The owner must change this
