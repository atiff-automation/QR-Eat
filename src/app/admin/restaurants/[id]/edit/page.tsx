            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Update essential restaurant information
                </p>
              </div>
            </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-800">
              ℹ️ Other settings (phone, email, description, timezone, currency,
              etc.) can be updated by the restaurant owner in their Settings
              page.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              />
              <p className="text-xs text-gray-500 mt-1">
                ⚠️ Changing this will affect the owner&apos;s login credentials
              </p>
            </div>
          </div>
        </div>
